...
*/
 ...
 //exercicio - deposito na conta do banco 
 
  
 val contaCorrente = ContaBanco(6000, 000.0, "João") 

    contaCorrente.consultarDeposito()
   // contaCorrente.saque()
    contaCorrente.deposito(500.0, 1409)
     contaCorrente.consultarDeposito()
}
...
println("O saldo de sua conta é R$$saldo") 
...
fun deposito(valor: Double, senha: Int){ 
  ...
  if(senha == 1409){ 
     if(saldo <= valor){ 
      ...
      println("Impossivel fazer o deposito de R$$valor")
     }else{
        println("Deposito acima do permitido! Deposito de R$$valor não realizado") 
     } 
      }else{ 
         println("Senha incorreta! Repita novamente ") 
      }
